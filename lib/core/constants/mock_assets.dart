abstract final class MockAssets {
  ...
  static const loginNeedVerifyOtp = '${_authMock}login_need_verify_otp_success.json';
  static const loginOtpLimitExceeded = '${_authMock}login_otp_limit_exceeded_failed.json';
  static const loginAccountIsDeleted = '${_authMock}login_account_is_deleted_failed.json';
  ...
  static const verifyOtpLoginSuccess = '${_authMock}verify_otp_login_flow_success.json';
  static const verifyOtpSignupSuccess = '${_authMock}verify_otp_signup_flow_success.json';

  // Forgot-password flow → challenge_type "reset_password": carries a session
  // token to set a new password next.
  static const verifyOtpForgotSuccess = '${_authMock}verify_otp_forgot_password_flow_success.json';

  // Wrong/expired OTP → failure (drives the "code invalid" error / lock).
  static const verifyOtpIncorrectFailed = '${_authMock}verify_otp_incorrect_failed.json';

  // Register-password (sign-up flow, after OTP) → returns auth tokens.
  static const registerPasswordSuccess = '${_authMock}register_password_success.json';
  static const registerPasswordFailed = '${_authMock}register_password_failed.json';

  // Forgot-password: send reset code → challenge_type "verify_otp".
  static const forgotPasswordSuccess = '${_authMock}forgot_password_success.json';
  ...
  static const changePasswordSuccess = '${_userMock}change_password_success.json';
