...
void main() {
  test('getPreferredSize is a square of side 2 * thumbRadius', () {
    const shape =
        CustomRangeThumbShape(thumbRadius: 12, fillColor: Color(0xFF000000));
  ...
  test('has the documented defaults', () {
    const shape =
        CustomRangeThumbShape(thumbRadius: 10, fillColor: Color(0xFFFFFFFF));
  ...
  test('is a RangeSliderThumbShape', () {
    const shape =
        CustomRangeThumbShape(thumbRadius: 8, fillColor: Color(0xFF112233));
