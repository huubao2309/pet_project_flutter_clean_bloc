    ...
    Animation<Size> thumbSizeAnimation(bool isForward) {
      ...
      if (isForward) {
        thumbSizeSequence = <TweenSequenceItem<Size>>[
          ...
          TweenSequenceItem<Size>(
              tween: ConstantTween<Size>(activeThumbSize), weight: 17),
        ];
      } else {
        thumbSizeSequence = <TweenSequenceItem<Size>>[
          TweenSequenceItem<Size>(
              tween: ConstantTween<Size>(inactiveThumbSize), weight: 17),
          TweenSequenceItem<Size>(
            tween: Tween<Size>(
              begin: inactiveThumbSize,
              end: transitionalThumbSize,
...
class _SwitchConfigCupertino with _SwitchConfig {
  ...
  List<BoxShadow>? get thumbShadow => const <BoxShadow>[
        BoxShadow(
            color: Color(0x26000000), offset: Offset(0, 3), blurRadius: 8.0),
        BoxShadow(
            color: Color(0x0F000000), offset: Offset(0, 3), blurRadius: 1.0),
      ];
...
class _SwitchConfigM2 with _SwitchConfig {
  ...
  @override
  double get switchWidth =>
      trackWidth - 2 * (trackHeight / 2.0) + switchMinSize.width;
